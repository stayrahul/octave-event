  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white selection:bg-purple-500/30 font-sans overflow-x-hidden">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-[#0A0A0A]/80 backdrop-blur-md border-b border-white/5">
        ...
        <nav className="max-w-7xl mx-auto px-4 md:px-12 flex items-center gap-2 md:gap-4 overflow-x-auto no-scrollbar border-t md:border-none border-white/5 py-3 md:py-0 md:absolute md:top-0 md:right-12 md:h-20 text-xs md:text-sm font-medium tracking-widest text-white/50 whitespace-nowrap">
          <button
          ...
          <AnimatePresence mode="wait">
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex items-center gap-3 text-white/60">
                          ...
                          <span className="text-xs md:text-sm">Venue: Announced Soon</span>
                        </div>
                      </div>
                    </div>
                ...
                >
                  ...
                  <div className="p-6 rounded-3xl bg-white/5 border border-white/10 flex items-start gap-4 hover:border-purple-500/30 hover:bg-purple-500/5 transition-all cursor-default group">
                    ...
                    <div>
                      ...
                      <h3 className="text-base font-bold text-white mb-1">To Be Announced Soon</h3>
                      <p className="text-xs text-white/50 leading-relaxed">We are selecting a premium, tech-equipped venue for the workshop. Registered attendees will receive location instructions via SMS/email.</p>
                    </div>
                  </div>
                </motion.div>
              ...
              >
                <div className="flex flex-col md:flex-row gap-8 md:gap-12">
                  ...
                  <motion.div variants={fadeUp} className="md:w-1/2 flex items-start justify-center pt-8 md:pt-0 md:sticky md:top-24 h-fit">
                    <div className="bg-white/5 border border-white/10 rounded-3xl p-8 md:p-12 backdrop-blur-md text-center shadow-2xl shadow-orange-500/10 w-full max-w-md relative overflow-hidden group">
            ...
            {activeTab === 'ai' && (
              ...
              >
                <div className="flex flex-col md:flex-row gap-8 md:gap-12">
                  <div className="md:w-1/2 space-y-6">
                    ...
                    <motion.div variants={fadeUp} className="space-y-4 md:space-y-6">
                      ...
                      <div className="group flex items-start gap-4 p-4 rounded-2xl bg-white/5 hover:bg-purple-500/10 border border-white/5 hover:border-purple-500/30 transition-all cursor-default">
                        ...
                        <div>
                          <p className="font-bold text-white text-lg">Workshop Venue</p>
                          <p className="text-sm text-white/60 mt-1">To be announced soon</p>
                          <p className="text-xs text-white/40 mt-1">We are finalizing a state-of-the-art tech lab facility. Registered participants will receive location details via SMS/email soon.</p>
                        </div>
                      </div>
                  ...
                  <motion.div variants={fadeUp} className="md:w-1/2 flex items-start justify-center pt-8 md:pt-0 md:sticky md:top-24 h-fit">
                    <div className="bg-white/5 border border-white/10 rounded-3xl p-8 md:p-12 backdrop-blur-md text-center shadow-2xl shadow-purple-500/10 w-full max-w-md relative overflow-hidden group">
            ...
            {activeTab === 'faq' && (
              ...
              >
                ...
                {[
                  { q: "Where is the event located?", a: "The PUBG Mobile Tournament is held physically at NCMT College, Samakhushi, Kathmandu. The venue for the Digital Marketing with AI Workshop is being finalized and will be announced very soon. Registered participants will receive exact location details and instructions via email and SMS." },
